...
from vetstats_app.analysis.treatment_cases import (
    ...
    build_treatment_duration_by_row,
)
...
_parse_dmy_date = parse_clinical_dmy_date
...
def _build_clinical_summary_lines(
    ...
    *,
    ...
    if duration_by_row is None:
        duration_by_row = build_treatment_duration_by_row(matched, clinical)
...
def build_patient_history_detail(
    ...
    if matched_clinical is not None and not matched_clinical.empty:
        duration_by_row = build_treatment_duration_by_row(
            matched_clinical,
            clinical,
        )
